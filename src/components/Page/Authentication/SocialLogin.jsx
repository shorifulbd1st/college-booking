    ...
    <div className="m-2">
      ...
      <div className="flex flex-col w-full  gap-y-2">
        <button
          ...
          className="bg-white cursor-pointer flex items-center text-gray-700 dark:text-gray-300 justify-center gap-x-3 text-sm sm:text-base dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 rounded-lg hover:bg-gray-100 duration-300 transition-colors border px-8 py-2.5"
        >
          <svg
