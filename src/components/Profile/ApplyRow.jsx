      ...
      <td className="px-4 py-4 text-sm whitespace-nowrap">
        <div className="flex items-center gap-x-4">
          ...
          <button
            ...
            className="cursor-pointer flex font-medium  items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500"
          >
            <MdRateReview />
            Review
          </button>
          ...
          <Link
            ...
            className="cursor-pointer font-medium  px-4 py-2 bg-rose-600 text-white rounded-md hover:bg-green-500"
          >
            Details
          </Link>
          <button
